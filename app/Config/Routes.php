...
$routes->get('/lista', 'Home::index');
$routes->get('/indexAgente', 'Home::indexAgente');
$routes->get('/index-Secretario-Agente', 'Home::indexSecretarioAgente');
$routes->get('/chat', 'Home::chat');
$routes->get('/restablecer-contraseña', 'Home::passwordReset');
