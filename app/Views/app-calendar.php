...
<head>
    ...
    <script src="../src/plugins/css/dark/fullcalendar/jquery-3.0.0.min.js"></script>

    <link rel="stylesheet" tipe="text/css" href="../css/alertify.css">
    <link rel="stylesheet" tipe="text/css" href="../css/themes/default.css">
...
<body class="dark layout-boxed">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="./index-Secretario-Agente" class="nav-link"> TLALTINANGO </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                            <li>
                                <a href="./index-Secretario-Agente"> Analytics </a>
                            </li>
                            <li>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row layout-top-spacing layout-spacing" id="cancel-row">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <?php if(session('mensaje')){ ?>
                                <!-- <div class="alert alert-light-info alert-dismissible fade show border-0 mb-4" id="alert" role="alert"> 
                                ...
                                <script type="text/javascript">
                                    alertify.success("<?php echo session('mensaje') ?>");
                                </script>
                            <?php } ?>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal" class="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="./detallesEvento" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="">
                                                ...
                                                <input title="Campo requerido" id="evento" name="evento" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 d-none">
                                            <div class="">
                                                ...
                                                <input id="event-start-date" name="event-start-date" type="text" class="form-control">
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex mt-4">
                                                <div class="n-chk">
                                                    <div class="form-check form-check-primary form-check-inline">
                                                        <input selected class="form-check-input" type="radio" name="event-level" value="Work" id="rwork">
                                                        <label class="form-check-label" for="rwork">Trabajo</label>
                                                    </div>
                                                </div>
                                                <div class="n-chk">
                                                    <div class="form-check form-check-warning form-check-inline">
                                                        <input class="form-check-input" type="radio" name="event-level" value="Travel" id="rtravel">
                                                        <label class="form-check-label" for="rtravel">Viaje</label>
                                                    </div>
                                                </div>
                                                <div class="n-chk">
                                                ...
                                                <div class="n-chk">
                                                    <div class="form-check form-check-danger form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="rImportant">Importante</label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success btn-update-event" name="actualizar" value="">Guardar cambios</button>
            ...
            <script type="text/javascript">
                ...
                */    
                ...
                var getDelete = document.querySelector('#btn-delete-event');
                ...
                var calendarEventClick = function(info) {
                    ...
                    getModalTitleEl.focus();
                    var getModalEventId = info.event._def.extendedProps._id; 
                    var getModalEventLevel = eventObj._def.extendedProps['calendar'];
                    var getModalCheckedRadioBtnEl = document.querySelector(`input[value="${getModalEventLevel}"]`);
                    getModalTitleEl.value = eventObj.title;
                    getModalCheckedRadioBtnEl.checked = true;
                    getModalUpdateBtnEl.setAttribute('value', getModalEventId);
                    getDelete.setAttribute('value', getModalEventId);
                    getModalAddBtnEl.style.display = 'none';
                    getModalUpdateBtnEl.style.display = 'block';
                    getDelete.style.display = 'block';
                    myModal.show();
                    ...
                    events: [
                      <?php
                       while($dataEvento = mysqli_fetch_array($resulEventos)){ ?>
                          ...
                          extendedProps: { calendar: '<?php echo $dataEvento['tipo']; ?>' },
    ...
    <script src="../src/plugins/src/fullcalendar/locales/es.js"></script>
