            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="../index-Secretario-Agente/calendar" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row layout-top-spacing layout-spacing" id="cancel-row">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="calendar-container"> hola
                                <div class="calendar fc fc-media-screen fc-direction-ltr fc-theme-standard" style="height: 900px;">
                                    <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                                        <div class="fc-toolbar-chunk">
                                            ...
                                            <button type="button" title="Add Event" aria-pressed="false" class="fc-addEventButton-button fc-button fc-button-primary" _msthash="1782833" _msttexthash="233493">
                                                Agregar evento
                                            </button>
                                        </div>
                                        <div class="fc-toolbar-chunk">
                                            <h2 class="fc-toolbar-title" id="fc-dom-1" _msthash="87243" _msttexthash="95186">
                                                Holaaaaa
                                            </h2>
                                        </div>
                                        <div class="fc-toolbar-chunk">
                                            <div class="fc-button-group">
                                                <button type="button" title="Vista por mes" aria-pressed="true" class="fc-dayGridMonth-button fc-button fc-button-primary fc-button-active" _msthash="2181738" _msttexthash="33878">
                                                    Mes                                                    
                                                </button>
                                                <button type="button" title="Vista por semana" aria-pressed="false" class="fc-timeGridWeek-button fc-button fc-button-primary" _msthash="2181739" _msttexthash="77194">
                                                    Semana                                                    
                                                </button>
                                                <button type="button" title="Vista por día" aria-pressed="false" class="fc-timeGridDay-button fc-button fc-button-primary" _msthash="2181740" _msttexthash="45097">
                                                    Día                                                   
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="">
                                                <label class="form-label">Escribe el evento</label>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-success btn-update-event" data-fc-event-public-id="">Guardar cambios</button>
                                    <button type="button" class="btn btn-primary btn-add-event">Agregar evento</button>
                                </div>
                            </div>
                        </div>
                    </div>
